...
def campo_electrico(X, Y, q, q_loc):
    ...
    #Q LOC ES LA COORDENADA DE LAS CARGAS
    X_new = X-q_loc[0]
    Y_new = Y-q_loc[1]
...
# Preguntar a edo ¿??? si sirve con linspace
"""
def parametros_init():
...
def main():
    ...
    # A partir de aqui, he creado una nueva figura en la que se mostraran 
    #los vectores unitarios
    # Crear Matriz con magnitudes de vectores
    mags = (Ex_def**2+Ey_def**2)*(1/2)

    # Vectores Unitarios
    #DIVIDIMOS LA SUMAT ENTRE LA MAGNITUD
    ...
    #CON QUIVER AGREGAS LAS FLECHAS

    # Dibujar Carga puntual
    if q > 0:
    #SCATTER DIBUJA MIS CARGAS SI SON ....
